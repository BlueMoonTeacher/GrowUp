                ...
                <div className="flex-1 overflow-y-auto custom-scrollbar p-2 sm:p-4 flex flex-col gap-2 bg-base-50/30">
                    {isWeekend && (
                        <div className="bg-orange-50 border border-orange-100 rounded-xl p-3 text-center shrink-0">
                            ...
                            <p className="text-orange-600 text-[10px] mt-1">필요하다면 기록을 남길 수 있어요.</p>
                        </div>
                    )}
                                    ...
                                    {isSpecialistView ? (
                                        <div className="md:col-span-10">
                                            ...
                                            <input
                                                ...
                                                className="w-full p-2 bg-purple-50/50 border border-purple-200 rounded-lg focus:ring-2 focus:ring-purple-400 focus:border-purple-400 transition-all text-xs text-purple-900 placeholder-purple-300 shadow-sm"
                                            />
                                        </div>
                                    ) : (
                                        <>
                                            <div className="md:col-span-6">
                                                ...
                                                <input
                                                    ...
                                                    className="w-full p-2 bg-white border border-base-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary transition-all text-xs text-base-content placeholder-base-300 shadow-sm"
                                                />
                                            </div>
                                            ...
                                            <div className="md:col-span-4">
                                                ...
                                                <div className="flex gap-1.5">
                                                    <input
                                                        ...
                                                        placeholder="https://"
                                                        className="w-full p-2 bg-white border border-base-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary transition-all text-xs text-blue-600 placeholder-base-300 shadow-sm"
                                                    />
                                                    {plan.materialLink && (
                                                        <button
