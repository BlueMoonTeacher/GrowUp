    ...
    >
      ...
      >
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-2xl font-bold text-base-content">{isInitialSetup ? '학급 정보 설정' : '설정 ⚙️'}</h2>
          {!isInitialSetup && (
           ...
           <div className="bg-primary/5 p-4 rounded-lg border border-primary/20">
              ...
              <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 p-2 border border-base-300 rounded-md focus:ring-primary focus:border-primary shadow-sm bg-white font-bold text-lg text-center"
                  />
                  <div className="flex flex-col justify-center text-xs text-base-content-secondary">
                      <span>학년도</span>
                  </div>
              </div>
