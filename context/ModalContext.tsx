            ...
            <div className="p-6">
              <div className="flex justify-between items-start mb-4">
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="text-lg font-bold text-base-content mt-1">{options.title}</h3>
                </div>
                <button onClick={handleCancel} className="text-base-content-secondary hover:bg-base-200 p-1.5 rounded-full transition-colors mt-1 -mr-2">
